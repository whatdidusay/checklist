  ...
  data() {
    return {
      ...
      list: [
        {
          title: "외관 품질",
          img: "/checklist/img/exterior.png",
        ...
        {
          title: "센터페시아, 콘솔 품질",
          img: "/checklist/img/interior.png",
          part: "조립상태, 편의장치",
          description:
        ...
        {
          title: "스티어링 휠",
          img: "/checklist/img/steering-wheel.png",
          part: "스티어링 휠 방향",
          description:
        ...
        {
          title: "조명장치 내부 품질",
          img: "/checklist/img/roomlamp.png",
          part: "내부 조명 확인",
          description:
